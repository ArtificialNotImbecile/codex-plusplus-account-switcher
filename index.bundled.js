...
`, "utf8");
    ...
    async function syncCodexConfigForAccount2(auth) {
      if (!isApiKeyAuth(auth)) {
    ...
    module2.exports = {
      ...
      syncCodexConfigForAccount: syncCodexConfigForAccount2,
...
`, "utf8");
    ...
    async function switchAccount(rawName, api2) {
      ...
      try {
        ...
        api2?.log?.warn?.(`[account-switcher] skipped config sync for ${name}: ${message}`);
      }
